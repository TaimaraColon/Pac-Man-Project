...
void GameOverState::tick() {
	...
	if(startButton->wasPressed()){
		setNextState("ChoosePlayer");  //hitting start takes you to choose a player state
		setFinished(true);
...
GameOverState::~GameOverState(){		//destructor para que una vez acabe el scope, se borre el gameover state
	delete startButton;
	delete anim;
}